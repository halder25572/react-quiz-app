    ...
    return (
        <div className='mt-4 py-4'>
            ...
            <div className="correctBtn float-right">
                <FontAwesomeIcon className='cursor-pointer' icon={faEye}></FontAwesomeIcon>
            </div>
                <h5 className="mb-2 text-3xl font-bold text-gray-900 dark:text-white">{question}</h5>
                    <div className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400 grid grid-rows-2 grid-flow-col gap-2">
